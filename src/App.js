...
const translations = {
  ...
  bn: {
    ...
    queries: {
      ...
      exams: "সরকারি পরীক্ষার সময়সূচি ২০২৬", passports: "পাসপোর্ট নবায়ন নথি",
      agriculture: "ফসল বীমা প্রকল্প", business: "MSME নিবন্ধন প্রক্রিয়া",
      electricity: "নতুন বিদ্যুৎ সংযোগ", health: "আয়ুষ্মান ভারত বিবরণ",
      housing: "PM আবাস যোজনা আবেদন", jobs: "সর্বশেষ সরকারি চাকরি",
      justice: "আইনি সহায়তা সেবা", local: "স্থানীয় পৌরসভা যোগাযোগ",
      lpg: "নতুন LPG সংযোগের আবেদন", banking: "জিরো ব্যালেন্স অ্যাকাউন্ট খোলা",
  ...
  mr: {
    ...
    queries: {
      ...
      exams: "सरकारी परीक्षा वेळापत्रक 2026", passports: "पासपोर्ट नूतनीकरण कागदपत्रे",
      agriculture: "पीक विमा योजना", business: "MSME नोंदणी प्रक्रिया",
      electricity: "नवीन वीज जोडणी", health: "आयुष्मान भारत तपशील",
      housing: "PM आवास योजना अर्ज", jobs: "नवीनतम सरकारी नोकऱ्या",
      justice: "कायदेशीर सहाय्य सेवा", local: "स्थानिक महापालिका संपर्क",
      lpg: "नवीन LPG जोडणीसाठी अर्ज", banking: "शून्य शिल्लक खाते उघडणे",
  ...
  gu: {
    ...
    queries: {
      ...
      exams: "સરકારી પરીક્ષા સમયપત્રક 2026", passports: "પાસપોર્ટ નવીકરણ",
      agriculture: "પાક વીમા યોજનાઓ", business: "MSME નોંધણી",
      electricity: "નવું વીજ જોડાણ", health: "આયુષ્માન ભારત",
      housing: "PM આવાસ યોજના", jobs: "સરકારી નોકરીઓ",
      justice: "કાનૂની સહાય", local: "સ્થાનિક મ્યુનિસિપાલિટી",
      lpg: "નવું LPG જોડાણ", banking: "ઝીરો બૅલૅન્સ ખાતું",
  ...
  pa: {
    ...
    queries: {
      ...
      exams: "ਸਰਕਾਰੀ ਪ੍ਰੀਖਿਆ ਸਮਾਂ-ਸੂਚੀ 2026", passports: "ਪਾਸਪੋਰਟ ਨਵੀਨੀਕਰਨ",
      agriculture: "ਫਸਲ ਬੀਮਾ ਯੋਜਨਾਵਾਂ", business: "MSME ਰਜਿਸਟ੍ਰੇਸ਼ਨ",
      electricity: "ਨਵਾਂ ਬਿਜਲੀ ਕੁਨੈਕਸ਼ਨ", health: "ਆਯੁਸ਼ਮਾਨ ਭਾਰਤ",
      housing: "PM ਆਵਾਸ ਯੋਜਨਾ", jobs: "ਸਰਕਾਰੀ ਨੌਕਰੀਆਂ",
      justice: "ਕਾਨੂੰਨੀ ਸਹਾਇਤਾ", local: "ਸਥਾਨਕ ਨਗਰਪਾਲਿਕਾ",
      lpg: "ਨਵਾਂ LPG ਕੁਨੈਕਸ਼ਨ", banking: "ਜ਼ੀਰੋ ਬੈਲੇਂਸ ਖਾਤਾ",
  ...
  or: {
    ...
    queries: {
      ...
      exams: "ସରକାରୀ ପରୀକ୍ଷା ସୂଚୀ 2026", passports: "ପାସପୋର୍ଟ ନବୀକରଣ",
      agriculture: "ଫସଲ ବୀମା ଯୋଜନା", business: "MSME ନିବନ୍ଧନ",
      electricity: "ନୂଆ ବିଦ୍ୟୁତ ସଂଯୋଗ", health: "ଆୟୁଷ୍ମାନ ଭାରତ",
      housing: "PM ଆବାସ ଯୋଜନା", jobs: "ସରକାରୀ ଚାକିରି",
      justice: "ଆଇନ ସହାୟତା", local: "ସ୍ଥାନୀୟ ନଗରପାଳିକା",
      lpg: "ନୂଆ LPG ସଂଯୋଗ", banking: "ଶୂନ୍ୟ ବ୍ୟାଲାନ୍ସ ଖାତା",
  ...
  as: {
    ...
    queries: {
      ...
      exams: "চৰকাৰী পৰীক্ষাৰ সময়সূচী 2026", passports: "পাছপোৰ্ট নবীকৰণ",
      agriculture: "শস্য বীমা আঁচনি", business: "MSME পঞ্জীয়ন",
      electricity: "নতুন বিদ্যুৎ সংযোগ", health: "আয়ুষ্মান ভাৰত",
      housing: "PM আৱাস যোজনা", jobs: "চৰকাৰী চাকৰি",
      justice: "আইনী সহায়তা", local: "স্থানীয় পৌৰ সভা",
      lpg: "নতুন LPG সংযোগ", banking: "শূন্য বেলেঞ্চ একাউণ্ট",
  ...
  ur: {
    ...
    queries: {
      ...
      exams: "سرکاری امتحان کا شیڈول 2026", passports: "پاسپورٹ تجدید",
      agriculture: "فصل بیمہ اسکیمیں", business: "MSME رجسٹریشن",
      electricity: "نیا بجلی کنکشن", health: "آیوشمان بھارت",
      housing: "PM آواس یوجنا", jobs: "سرکاری ملازمتیں",
      justice: "قانونی امداد", local: "مقامی میونسپلٹی",
      lpg: "نیا LPG کنکشن", banking: "زیرو بیلنس اکاؤنٹ",
